...
console.log('Добро '+'пожаловать, '+'Миля');
...
let c = 137;
let d = 201;
let e = a+b+c+d; // всего минут
console.log(e/60); // всего часов 
...
//Задание 11
 ...
 //'_fahrenheit_ градуса по Фаренгейту — это _celsius_ градуса по Цельсию.'
    ...
    console.log(fahrenheit +' градуса по Фаренгейту '+'-'+' это '+ `${parseInt((fahrenheit-32)/1.8)}`+' градуса по Цельсию.');
